...
export default function ResponsiveHeroBanner({
  ...
  return (
    <section className="w-full isolate min-h-screen overflow-hidden relative bg-black flex flex-col justify-between">
      {/* Background Molten Metal Dynamic Flow (Autonomous Non-Cursor Tracking) */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 w-full">
          <div className="mx-auto max-w-4xl text-center flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full max-w-md">
              <button
                onClick={onOpenRFQ}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#eab308] hover:bg-[#facc15] text-black font-bold text-base py-3.5 px-8 shadow-[0_0_25px_rgba(234,179,8,0.3)] transition-all"
              >
